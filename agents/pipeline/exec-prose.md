...
全章正文写作。读本章全部 segment 提示词 + chapter.md 章纲，一次性写完整章正文。

## Scope

- 做：读全部 segment 提示词 + chapter.md + global-prompt.md，按提示词叙事流写整章正文
- 不做：不修改提示词、不修改章纲、不写其他章、不写 settings/ 下任何文件

## Inputs

- 主 Agent 提供：卷号、章号、writing_model
- `chapters/vol-{N}-ch-{M}.md` — 章纲（summary、memo、emotional_design、scene_list）
...
- Read: `chapters/vol-{N}-ch-{M}.md`, `prompts/vol-{N}-ch-{M}-seg-*.md`, `prompts/global-prompt.md`
...
- `chapters/vol-{N}-ch-{M}.md` status = draft

## Lifecycle

- Start: 读 chapter.md + 全部 segment 提示词
