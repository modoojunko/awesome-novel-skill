...
- **Section Definitions（ACT 阶段加载 prompt-setting-style.md）：**
  ...
  - 输出·写作规范：视角策略/描写/节奏/句式/情绪/信息要求 + 反AI + 通用技法（prose+pov稀疏注入）+ 场景方法论（四步转化后注入）+ 叙事规则（优先级层：第1层·约束红线 > 第2层·字数 > 第3层·T1词/认知动词/感官 > 第4层·叙事规则 > 第5层·写作规范其他规则。第4层内，叙事规则高于写作规范同级规则）
