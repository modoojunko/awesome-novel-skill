...
在新章编写过程中，当 author 的反馈出现以下特征文字时，主动建议使用推演沙盘：

| 特征文字 | 建议话术 |
|---------|---------|
| "不知道怎么写" / "接下来怎么写" / "写不出来" | "要不要跑一下推演沙盘？让角色自己演一遍这章的核心故事，剧情自然就出来了" |
| "这个场景/对话/反应不对" / "不像" / "太生硬" | "感觉不对的话，可以跑一轮推演，看看角色在这个场景下到底会怎么反应" |
| "很乱" / "理不清" / "捋不顺" | "多角色互动容易乱，让沙盘逐个角色推演一遍，谁先谁后就清楚了" |
| "没画面感" / "写出来是空的" | "场景出不来画面的话，推演一下看看角色在环境中的具体行为，画面感就有了" |
