...
- **去 AI 味**：写完后自动检测"机器腔"——句式开头重复、身体反应模板化（"眼神一暗""心里一沉"用太多）、公式化副词（"不由得""不禁"），有就标出来让你决定要不要改
...
默认写作风格就是"低 AI 味"配置——禁止了常见的机器腔句式（"不由得""不禁""就在这时"）、强制短句长句交替、禁止身体反应模板化。写完后还会自动扫描检测，发现 AI 味重的地方会标出来让你改。

## 📈 Stats

[![Repo Stats](https://github-readme-stats.vercel.app/api/pin/?username=modoojunko&repo=awesome-novel-skill&theme=white)](https://github.com/modoojunko/awesome-novel-skill)
