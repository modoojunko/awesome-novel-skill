...
本项目 v2 的部分设计受到以下优秀项目的启发：

- **[InkOS](https://github.com/Narcooo/inkos)** — 自主小说写作 AI Agent。我们借鉴了其 AI 味检测体系（疲劳词 blocklist 和句式规则）、伏笔/钩子全生命周期追踪（payoff_timing 调度和健康检查）、题材配置系统（genre profiles）以及三层技法分发模型（结构层/内容层/审查层），适配到本项目的引导式协作工作流中。

我们对 InkOS 的作者 [@Narcooo](https://github.com/Narcooo) 表示诚挚感谢。
